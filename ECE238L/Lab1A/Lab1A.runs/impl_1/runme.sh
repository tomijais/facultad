...
HD_PWD='C:/Users/tjais/ECE238L/Lab1A/Lab1A.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab1A.tcl -notrace
