...
HD_PWD='C:/Users/tjais/ECE238L/Lab1A/Lab1A.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab1A.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab1A.tcl
