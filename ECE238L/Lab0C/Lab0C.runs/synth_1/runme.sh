...
HD_PWD='C:/Users/tjais/ECE238L/Lab0C/Lab0C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab0C.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab0C.tcl
