...
HD_PWD='C:/Users/tjais/ECE238L/Lab0C/Lab0C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab0C.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab0C.tcl -notrace
