...
HD_PWD='C:/Users/tjais/Lab0A/Lab0A.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab0A.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab0A.tcl -notrace
