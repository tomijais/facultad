...
HD_PWD='C:/Users/tjais/AND_3/AND_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log AND_3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source AND_3.tcl -notrace
